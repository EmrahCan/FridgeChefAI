  ...
  return [
    {
      ...
      ingredients: [
        ...
        { id: '3', name: 'Red Bell Pepper', category: 'Produce & Veggies', confidence: 0.91, suggestedAction: 'Fırınla' },
        { id: '4', name: 'Plain Greek Yogurt', category: 'Dairy', confidence: 0.88, suggestedAction: 'Taze' },
        { id: '5', name: 'Cheddar / Cheese Scraps', category: 'Dairy', confidence: 0.93, suggestedAction: 'Fırınla' },
      ],
      recipes: [
        {
          id: 'rec-1',
    ...
    },
    {
      ...
      ingredients: [
        ...
        { id: '12', name: '2 Fresh Eggs', category: 'Meat & Deli', confidence: 0.97, suggestedAction: 'Taze' },
        { id: '13', name: '1 Soft Tomato', category: 'Produce & Veggies', confidence: 0.89, suggestedAction: 'Fırınla' },
        { id: '14', name: 'Pitted Olives', category: 'Other', confidence: 0.92, suggestedAction: 'Taze' },
      ],
      recipes: [
        {
          id: 'rec-3',
